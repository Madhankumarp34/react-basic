...
const RestroCard = (props) =>{
  const { resData } = props;
  const { name, avgRating, cuisines, deliveryTime, costForTwo } = resData.data;
  return (
    <div className="restro-card">
    <img alt="restro-img" className="restro-img" src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/v1682761605/04c99ec307cbf31da2040426983c4acb.jpg" />
      <h3>{name}</h3>
      <h4>{cuisines.join(", ")}</h4>
